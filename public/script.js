...
let btnforge = document.getElementById('btnforge');
...
btnforge.onclick = function() { btnaccueil.setAttribute('class', ' ');
	btnmarche.setAttribute('class', ' ');
	btncollection.setAttribute('class', ' ');
	btnforge.setAttribute('class', 'active');
	btnpropos.setAttribute('class', ' ');
};
